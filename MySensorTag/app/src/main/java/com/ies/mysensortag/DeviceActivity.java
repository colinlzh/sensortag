        ...
        mDrawerList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position){
                    case 0:
                        model=0;
                        if(!tvdata[2].equals(null)&&tvdata[2].length()>0)tvtem.setText(tvdata[2]+"%");
                        else tvtem.setText("33%");
                        mDrawerLayout.closeDrawer(Gravity.START);
                        break;
                    case 1:
                        model=1;
                        if(!tvdata[1].equals(null)&&tvdata[1].length()>0)tvtem.setText(tvdata[1]+"°");
                        else tvtem.setText("6°");
                        mDrawerLayout.closeDrawer(Gravity.START);
                        break;
                    case 2:
                        model=2;
        ...
        public void run() {
                ...
                try {
                    ...
                    if(statusCode == 200){
                    	...
                    	Log.e(TAG_, EntityUtils.toString(response.getEntity()));
                    }
